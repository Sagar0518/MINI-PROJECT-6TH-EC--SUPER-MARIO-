...
function draw() {
  ...
  if(gameState==="PLAY"){
    ...
    //After the score of 50 - level 2 
    goombaGroup.velocityX = -(20 + 4* score/50);

    //Score: for every 100 getting checkpoint sound  
    ...
    if(mario.isTouching(coinGroup)){
     ...
     //After the score of 100-Level 3
...
function spawnCoin(){
    ...
    //lifetime
    //speed=distance/time --> t= d/s = 1500/20 =75
    coin.lifetime=75;
    coinGroup.add(coin);     
    }  
  }
